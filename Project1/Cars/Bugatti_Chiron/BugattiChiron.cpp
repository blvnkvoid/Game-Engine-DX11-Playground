...
VehicleDefinition Chiron::CreateDefinition()
{
    ...
    // Old Chiron definition had:
    // car.springStiffness = 50000.0f;
    //
    // Current VehicleDefinition separates front/rear spring rates.
    car.suspension.frontSpringRate = 50000.0f;
    ...
    // ---------------------------------------------------------
    // 10. Audio
    // Temporary Audi R10 audio configuration
    // ---------------------------------------------------------
    car.audio.basePath =
        "C:\\Users\\Void\\Documents\\GitHub\\Game-Engine\\Project1\\Cars\\Audi_R10\\sounds\\";
